...
*/
            ...
            boolean r2 =  characters.contains('A'); //r2= true

            boolean r3 = characters.contains('Z'); // r3= false
            ...
            System.out.println(list1 == list2); // false  ('new' (memory location)unutma 2different object )
            System.out.println(list1.equals(list2)); //true (elementler eşit)
