...
public class CarObjects {
    public static void main(String[] args) {
        ...
        //Car[] cars = {car1, car2, car3};  create arrays of  cars

        ArrayList<Car> carsList = new ArrayList<>(); // ArrayList custom objects OOP TA KULLANACAĞIZ
        carsList.addAll(Arrays.asList(car1, car2, car3)); //   converted to collections
        //iterated ArrayList by loop
