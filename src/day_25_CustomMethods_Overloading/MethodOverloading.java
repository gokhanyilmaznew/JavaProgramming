...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        int[] intArray = {5,6,0,-1,3,4}; // sort method we have using before use in an overloading method.
    ...
    public static int sumOfNumbers(int num1, int num2){ //6 method var 6 function var
