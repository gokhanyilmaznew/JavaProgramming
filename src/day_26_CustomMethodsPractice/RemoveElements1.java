...
public class RemoveElements1 {
    ...
    public static void main(String[] args) {
        ...
        numbers = removeElement(numbers, 1); //{100, 300, 400, 500, 600} 1. index atla
        numbers = removeElement(numbers, 1); //[100, 400, 500, 600] 1 daha atladık
    ...
    public static int[] removeElement(int[] array, int index){
        ...
        int j = 0;
        for (int i= 0; i < array.length; i++) { // converted to regular for loop
            if(i == index){  // if the index of array is matching with the given index
                continue; // skip , eşleşiyorsa onu geç demek
            }
            result[j++] = array[i];
        }
        return result;
    ...
    public static double[] removeElement(double[] array, int index){
        ...
        if(index < 0 || index > array.length-1){ // index <0 or greater than last index of array invalid index mesajı verir.
            System.err.println("Invalid Index: "+index); // error mesajı veriyor
            System.exit(0);
        }
