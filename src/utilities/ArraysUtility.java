...
public class ArraysUtility {
    ...
    //prints each integer of an integer array in separate lines // functionality si daha okunabilir anlaşılabir method PrintEachElement
 ...
 //             {1, 2, 3, 4} 6 contain in the int arrayor not?
